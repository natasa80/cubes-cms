...
//default form data//mi nemamo default vrednosti
        ...
        if ($request->isPost() && $request->getPost('task') === 'save') {//ispitujemo da lije pokrenuta forma
            try {
                ...
                //remove key memebr_photo from form data because there is no column memebr_photo in cms _indexSlides
    ...
    public function updateorderAction() {
        ...
        try {
            ...
            $cmsIndexSlidesTable->updateIndexSlideOfOrder($sortedIds);
